/*! For license information please see vendor.7ed2fd56f986569b43de.bundle.js.LICENSE.txt */
(() => {
  "use strict";
  var t = {
      d: (e, i) => {
  ...
  const be = {
    ...
    getDataAttributes(t) {
      ...
      for (const n of i) {
        let i = n.replace(/^bs/, "");
        (i = i.charAt(0).toLowerCase() + i.slice(1)), (e[i] = ge(t.dataset[n]));
      }
      return e;
    },
  ...
  class Fe extends ve {
    ...
    _handleSwipe() {
      ...
      (this._deltaX = 0),
        e && Ut(e > 0 ? this._config.rightCallback : this._config.leftCallback);
    }
    _initEvents() {
      this._supportPointerEvents
  ...
  class ms extends ye {
    ...
    _createTipElement(t) {
      ...
      return (
        e.setAttribute("id", i), this._isAnimated() && e.classList.add(ss), e
      );
    }
    setContent(t) {
      (this._newContent = t),
      ...
      for (const e of t)
        if ("click" === e)
          ...
          pe.on(this._element, t, this._config.selector, (t) => {
            const e = this._initializeOnDelegatedTarget(t);
            (e._activeTrigger["focusin" === t.type ? hs : cs] = !0), e._enter();
          }),
